...
(ns x.environment.crawler-handler.helpers
...
(defn sitemap-xml
  ...
  ; @return (string)
  []
  (if-let [sitemap-routes @(r/subscribe [:x.router/get-sitemap-routes])]
...
(defn robots-txt
  ...
  ; @return (string)
  [{:keys [server-name]}]
  (let [app-home @(r/subscribe [:x.router/get-app-home])
        timestamp (time/timestamp-string)]
       (str "\n# Generated by: " x.app-details/app-codename
