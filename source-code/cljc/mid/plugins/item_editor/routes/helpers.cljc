...
(ns mid.plugins.item-editor.routes.helpers
...
(defn base-route
  ...
  ;
  ; @example
  ;  (routes.helpers/base-route :my-extension :my-type {:route-template "/@app-home/my-extension/:item-id"})
  ;  =>
...
(defn extended-route
  ...
  ;
  ; @example
  ;  (routes.helpers/extended-route :my-extension :my-type {:route-template "/@app-home/my-extension/:item-id"})
  ;  =>
