...
(a/reg-event-fx
  ...
  (fn [_ [_ extension-id item-namespace item-id]]
      [:ui/blow-bubble! :plugins.item-browser/item-deleted-dialog
                        {:body [update.views/item-deleted-dialog-body extension-id item-namespace item-id]}]))
...
(a/reg-event-fx
  ...
  (fn [{:keys [db]} [_ extension-id item-namespace item-id changes]]
      ...
      (let [db           (r update.events/update-item!                    db extension-id item-namespace item-id changes)
            query        (r update.queries/get-update-item-query          db extension-id item-namespace item-id)
            validator-f #(r update.validators/update-item-response-valid? db extension-id item-namespace %)]
...
(a/reg-event-fx
  ...
  (fn [{:keys [db]} [_ extension-id item-namespace item-id _]]
      {:db (r update.events/item-updated db extension-id item-namespace item-id)}))
...
(a/reg-event-fx
  ...
  ; @param (map) server-response
  (fn [{:keys [db]} [_ extension-id item-namespace item-id _]]
      {:db (r update.events/update-item-failed db extension-id item-namespace item-id)
...
(a/reg-event-fx
  ...
  (fn [{:keys [db]} [_ extension-id item-namespace item-id]]
      (let [query        (r update.queries/get-delete-item-query          db extension-id item-namespace item-id)
...
(a/reg-event-fx
  ...
  (fn [{:keys [db]} [_ extension-id item-namespace item-id]]
      (let [query        (r update.queries/get-duplicate-item-query          db extension-id item-namespace item-id)
...
(a/reg-event-fx
  ...
  (fn [{:keys [db]} [_ extension-id item-namespace copy-id]]
      (let [query        (r update.queries/get-undo-duplicate-item-query          db extension-id item-namespace copy-id)
