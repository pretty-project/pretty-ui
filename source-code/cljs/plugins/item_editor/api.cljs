...
(ns plugins.item-editor.api
    (:require [plugins.item-editor.backup.events]
              ...
              [plugins.item-editor.form.effects]
...
(def revert-item-icon-button core.views/revert-item-icon-button)
(def revert-item-button      core.views/revert-item-button)
(def revert-item-block       core.views/revert-item-block)
(def delete-item-icon-button core.views/delete-item-button)
(def delete-item-button      core.views/delete-item-icon-button)
(def delete-item-block       core.views/delete-item-block)
(def copy-item-icon-button   core.views/copy-item-button)
(def copy-item-button        core.views/copy-item-icon-button)
(def copy-item-block         core.views/copy-item-block)
(def save-item-icon-button   core.views/save-item-icon-button)
(def save-item-button        core.views/save-item-button)
(def save-item-block         core.views/save-item-block)
