...
(ns templates.item-handler.api
    (:require [engines.item-handler.api]
              ...
              [templates.item-handler.comments.views :as comments.views]
              ...
              [templates.item-handler.warnings.views :as warnings.views]
...
; templates.item-handler.comments.views
(def comments comments.views/view)
...
; templates.item-handler.warnings.views
(def warnings warnings.views/view)
