...
(ns elements.form.effects
    (:require [re-frame.api :as r]))

;; ----------------------------------------------------------------------------
;; ----------------------------------------------------------------------------

(r/reg-event-fx :elements.form/validate-input!
  ...
  ;
  ; @usage
  ; [:elements.form/validate-input! :my-input {...}]
  (fn [_ [_ input-id validation-props]]
      {:fx [:elements.form/validate-input! input-id validation-props]}))

(r/reg-event-fx :elements.form/validate-form!
  ...
  (fn [_ [_ form-id validation-props]]
      {:fx [:elements.form/validate-form! form-id validation-props]}))
