...
(ns engines.item-browser.download.queries
    (:require [engines.item-browser.core.subs     :as core.subs]
...
(defn get-request-item-query
  ...
  (let [resolver-id    (r download.subs/get-resolver-id   db browser-id :get-item)
       ...
       ; nem szükséges alkalmazni, mivel az engine alapját adó item-lister engine
