...
(r/reg-event-fx :x.compontents/initialize-component!
  ; WARNING! NON-PUBLIC! DO NOT USE!
  ;
  ; @param (keyword) component-id
  ; @param (map) context-props
  ; @param (keyword) mount-id
  (fn [_ _]))
  ; Az x4.4.8 verzióig a komponensek inicializálása a [:x.compontents/initialize-component! ...]
  ; eseményben történt, amely esemény a komponensek gyorsabb felépülése érdekében összevonásra
  ; került a [:x.compontents/component-mounted ...] eseménnyel.

(r/reg-event-fx :x.compontents/destruct-component!
  ; WARNING! NON-PUBLIC! DO NOT USE!
  ;
  ; @param (keyword) component-id
  ; @param (map) context-props
...
(r/reg-event-fx :x.compontents/component-mounted
  ; WARNING! NON-PUBLIC! DO NOT USE!
  ;
  ; @param (keyword) component-id
  ; @param (map) context-props
...
(r/reg-event-fx :x.compontents/component-updated
  ; WARNING! NON-PUBLIC! DO NOT USE!
  ;
  ; @param (keyword) component-id
  ; @param (map) context-props
  ...
  (fn [{:keys [db]} [_ component-id {:keys [updater] :as context-props} _]]
      ...
      ;   a Re-Frame adatbázisban, kevés értelme van a [:x.compontents/component-updated ...]
      ;   eseményt alkalmazni.
...
(r/reg-event-fx :x.compontents/component-unmounted
  ; WARNING! NON-PUBLIC! DO NOT USE!
  ;
  ; @param (keyword) component-id
  ; @param (map) context-props
  ...
  (fn [{:keys [db]} [_ component-id context-props mount-id]]
      {:db             (r engine/set-component-prop! db component-id :status :unmounted)
       :dispatch-later [{:ms COMPONENT-DESTRUCTION-DELAY
                         :dispatch [:x.compontents/destruct-component! component-id context-props mount-id]}]}))
...
(defn- lifecycle-controller
  ...
  (let [mount-id (random/generate-keyword)]
       (reagent/lifecycles {:component-did-mount    #(r/dispatch [:x.compontents/component-mounted   component-id context-props mount-id])
                           ; WARNING! DEPRECATED! DO NOT USE!
                            ;:component-did-update   #(r/dispatch [:x.compontents/component-updated   component-id context-props mount-id])
                            :component-will-unmount #(r/dispatch [:x.compontents/component-unmounted component-id context-props mount-id])
