...
(ns x.environment.element-handler.side-effects
...
; @usage
;  [:x.environment/focus-element! "my-element"]
(r/reg-fx :x.environment/focus-element! focus-element!)
...
(r/reg-fx :x.environment/blur-element! blur-element!)
...
; @usage
;  [:x.environment/add-element-class! "my-element" "my-class"]
(r/reg-fx :x.environment/add-element-class! add-element-class!)
...
; @usage
;  [:x.environment/remove-element-class! "my-element" "my-class"]
(r/reg-fx :x.environment/remove-element-class! remove-element-class!)
...
; @usage
;  [:x.environment/set-element-style! "my-element" {:opacity "1"}]
(r/reg-fx :x.environment/set-element-style! set-element-style!)
...
; @usage
;  [:x.environment/remove-element-style! "my-element"]
(r/reg-fx :x.environment/remove-element-style! remove-element-style!)
...
; @usage
;  [:x.environment/set-element-style-value! "my-element" "opacity" "1"]
(r/reg-fx :x.environment/set-element-style-value! set-element-style-value!)
...
; @usage
;  [:x.environment/remove-element-style-value! "my-element" "opacity"]
(r/reg-fx :x.environment/remove-element-style-value! remove-element-style-value!)
...
; @usage
;  [:x.environment/set-element-attribute! "my-element" "my-attribute" "my-value"]
(r/reg-fx :x.environment/set-element-attribute! set-element-attribute!)
...
; @usage
;  [:x.environment/remove-element-attribute! "my-element" "my-attribute"]
(r/reg-fx :x.environment/remove-element-attribute! remove-element-attribute!)
...
; @usage
;  [:x.environment/set-element-content! "my-element" "My content"]
(r/reg-fx :x.environment/set-element-content! set-element-content!)
...
; @usage
;  [:x.environment/empty-element! "my-element"]
(r/reg-fx :x.environment/empty-element! empty-element!)
...
; @usage
;  [:x.environment/remove-element! "my-element"]
(r/reg-fx :x.environment/remove-element! remove-element!)
...
; @usage
;  [:x.environment/reveal-element! "my-element"]
(r/reg-fx :x.environment/reveal-element! reveal-element!)
...
; @usage
;  [:x.environment/hide-element! "my-element"]
(r/reg-fx :x.environment/hide-element! hide-element!)
...
; @usage
;  [:x.environment/remove-element-animated! 500 "my-element"]
(r/reg-fx :x.environment/remove-element-animated! remove-element-animated!)
...
; @usage
;  [:x.environment/hide-element-animated! 500 "my-element"]
(r/reg-fx :x.environment/hide-element-animated! hide-element-animated!)
...
; @usage
;  [:x.environment/reveal-element-animated! "my-element"]
(r/reg-fx :x.environment/reveal-element-animated! reveal-element-animated!)
...
; @usage
;  [:x.environment/mark-element-masspoint-orientation! "my-element"]
(r/reg-fx :x.environment/mark-element-masspoint-orientation! mark-element-masspoint-orientation!)
...
; @usage
;  [:x.environment/unmark-element-masspoint-orientation! "my-element"]
(r/reg-fx :x.environment/unmark-element-masspoint-orientation! unmark-element-masspoint-orientation!)
...
; @usage
;  [:x.environment/set-selection-start! "my-element" 2]
(r/reg-fx :x.environment/set-selection-start! set-selection-start!)
...
; @usage
;  [:x.environment/set-selection-end! "my-element" 2]
(r/reg-fx :x.environment/set-selection-end! set-selection-end!)
...
; @usage
;  [:x.environment/set-selection-range! "my-element" 2 10]
(r/reg-fx :x.environment/set-selection-range! set-selection-range!)
...
; @usage
;  [:x.environment/set-caret-position! "my-element" 20]
(r/reg-fx :x.environment/set-caret-position! set-caret-position!)
...
; @usage
;  [:x.environment/move-caret-to-start! "my-element"]
(r/reg-fx :x.environment/move-caret-to-start! move-caret-to-start!)
...
; @usage
;  [:x.environment/move-caret-to-end! "my-element"]
(r/reg-fx :x.environment/move-caret-to-end! move-caret-to-end!)
