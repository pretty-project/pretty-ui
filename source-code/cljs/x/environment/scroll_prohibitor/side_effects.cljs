...
(ns x.environment.scroll-prohibitor.side-effects
...
;
; To avoid flickering:
; Az [:x.environment/enable-dom-scroll! ...] mellékhatás esemény működését nem lehetséges
...
(r/reg-fx :x.environment/enable-dom-scroll! enable-dom-scroll!)

; WARNING! NON-PUBLIC! DO NOT USE!
(r/reg-fx :x.environment/disable-dom-scroll! disable-dom-scroll!)
