...
(defn store-cookie-value!
  ...
  (assoc-in db [:x.environment :cookie-handler/stored-cookies cookie-id] value))
...
(defn remove-cookie-value!
  ...
  ; return (map)
  [db [_ cookie-id]]
  (dissoc-in db [:x.environment :cookie-handler/stored-cookies cookie-id]))
...
(defn cookies-removed
  ; WARNING! NON-PUBLIC! DO NOT USE!
  [db _]
  (dissoc-in db [:x.environment :cookie-handler/stored-cookies]))
...
(defn inject-cookie-browser-settings!
  ...
  (let [enabled-by-browser? (.isEnabled goog.net.cookies)]
       (assoc-in cofx [:db :x.environment :cookie-handler/meta-items :enabled-by-browser?] enabled-by-browser?)))
...
(defn inject-system-cookie-value!
  ...
  (assoc-in cofx [:x.environment :cookie-handler/stored-cookies cookie-id] value))
...
; WARNING! NON-PUBLIC! DO NOT USE!
(r/reg-event-db :x.environment/cookie-set cookie-set)

; WARNING! NON-PUBLIC! DO NOT USE!
(r/reg-event-db :x.environment/cookie-removed cookie-removed)

; WARNING! NON-PUBLIC! DO NOT USE!
(r/reg-event-db :x.environment/cookies-removed cookies-removed)

; WARNING! NON-PUBLIC! DO NOT USE!
(r/reg-cofx :x.environment/inject-cookie-browser-settings! inject-cookie-browser-settings!)

; WARNING! NON-PUBLIC! DO NOT USE!
(r/reg-cofx :x.environment/inject-system-cookies! inject-system-cookies!)
