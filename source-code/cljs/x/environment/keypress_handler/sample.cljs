...
(ns x.environment.keypress-handler.sample
...
; Az [:x.environment/reg-keypress-event! ...] esemény meghívásával tudsz billentyű-lenyomásra
; vagy -felengedésre reagáló eseményeket regisztrálni.
(r/reg-event-fx :reg-my-keypress-event!
  [:x.environment/reg-keypress-event! :my-event {}])
...
; Az [:x.environment/remove-keypress-event! ...] esemény meghívásával tudod eltávolítani az egyes
