...
(ns x.gestures.api
    (:require [x.gestures.step-handler.effects]
              [x.gestures.step-handler.events]
              [x.gestures.select-handler.events :as select-handler.events]
              [x.gestures.select-handler.subs   :as select-handler.subs]
              [x.gestures.step-handler.subs     :as step-handler.subs]
              [x.gestures.view-handler.events   :as view-handler.events]
              [x.gestures.view-handler.subs     :as view-handler.subs]))
...
; x.gestures.select-handler.events
...
; x.gestures.select-handler.subs
