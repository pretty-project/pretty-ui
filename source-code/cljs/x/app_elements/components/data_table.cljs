...
(ns x.app-elements.components.data-table
    (:require [mid-fruits.candy                :refer [param]]
              [x.app-components.api            :as components]
              [x.app-core.api                  :as a :refer [r]]
              [x.app-elements.components.table :as components.table :refer [table]]
...
(defn- table-props-prototype
  ...
  (let [data-table-props (data-table-props-prototype table-props)]
       (components.table/table-props-prototype data-table-props)))
