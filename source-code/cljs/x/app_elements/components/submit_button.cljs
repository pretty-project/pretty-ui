...
(ns x.app-elements.components.submit-button
    (:require [mid-fruits.candy                 :refer [param]]
              [x.app-core.api                   :as a :refer [r]]
              [x.app-elements.components.button :as components.button :refer [button]]
...
(defn element
  ...
  ([button-id button-props]
   (let [button-props (-> button-props button-props-prototype components.button/button-props-prototype)]
