...
(ns pretty-inputs.api
    (:require [pretty-inputs.checkbox.effects]
              ...
              [pretty-inputs.password-field.effects]
              [pretty-inputs.password-field.side-effects]
              [pretty-inputs.plain-field.effects]
              [pretty-inputs.plain-field.events]
