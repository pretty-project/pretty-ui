...
(ns pretty-inputs.label.views
    (:require [fruits.random.api                :as random]
              [metamorphic-content.api          :as metamorphic-content]
              [pretty-css.content.api           :as pretty-css.content]
              [pretty-inputs.label.attributes :as label.attributes]
              [pretty-inputs.label.env        :as label.env]
              [pretty-inputs.label.prototypes :as label.prototypes]
...
(defn- input-lifecycles
  ...
  (reagent/lifecycles {:component-did-mount    (fn [_ _] (pretty-inputs.engine/input-did-mount    label-id label-props))
