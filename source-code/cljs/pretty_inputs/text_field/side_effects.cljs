...
; @param (keyword) field-id
; @param (map) field-props
(r/reg-fx :pretty-inputs.text-field/reg-keypress-events! reg-keypress-events!)

; @ignore
;
; @param (keyword) field-id
; @param (map) field-props
(r/reg-fx :pretty-inputs.text-field/dereg-keypress-events! dereg-keypress-events!)
