...
;
; @param (keyword) field-id
(r/reg-fx :pretty-inputs.plain-field/empty-field! empty-field!)

; @ignore
;
; @param (keyword) field-id
(r/reg-fx :pretty-inputs.plain-field/focus-field! focus-field!)

; @ignore
;
; @param (keyword) field-id
(r/reg-fx :pretty-inputs.plain-field/show-surface! show-surface!)

; @ignore
;
; @param (keyword) field-id
(r/reg-fx :pretty-inputs.plain-field/hide-surface! hide-surface!)

; @ignore
;
; @param (keyword) field-id
(r/reg-fx :pretty-inputs.plain-field/set-type-mode! set-type-mode!)

; @ignore
;
; @param (keyword) field-id
(r/reg-fx :pretty-inputs.plain-field/quit-type-mode! quit-type-mode!)
