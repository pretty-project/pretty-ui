...
(ns app-extensions.media.engine
...
(defn namespace->query-id
  ...
  ;
  ; @example
  ;  (engine/namespace->query-id :app-extensions.media.file-storage)
  ;  => :app-extensions.media.file-storage/synchronize!
  ;
  ; @return (keyword)
  [namespace]
...
(defn namespace->partition-id
  ...
  ;
  ; @example
  ;  (engine/namespace->partition-id :app-extensions.media.file-storage)
  ;  => :app-extensions.media.file-storage/primary
  ;
