...
(ns app-plugins.item-editor.color-handler.views
    (:require [app-plugins.item-editor.color-handler.config :as color-handler.config]
...
(defn color-picker-dialog-body
  ...
  [elements/color-picker ::color-picker
                         {:initial-options color-handler.config/COLORS
