...
(ns pretty-elements.menu-item.prototypes
    (:require [pretty-elements.properties.api :as pretty-elements.properties]
              ...
              [pretty-elements.dropdown-menu.side-effects :as dropdown-menu.side-effects]))
...
(defn item-props-prototype
  ...
  (-> item-props (pretty-elements.properties/inherit-icon-props)
                 ...
                 (assoc :on-mouse-over-f #(let [dropdown-content (:dropdown-content item-props)
                                                menu-id          (:menu-id          item-props)]
                                               (dropdown-menu.side-effects/set-dropdown-content! menu-id dropdown-content)))))
