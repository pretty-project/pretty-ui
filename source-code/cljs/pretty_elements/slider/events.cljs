...
(ns pretty-elements.slider.events
...
; @ignore
(r/reg-event-db :pretty-elements.slider/decrease-value! decrease-value!)

; @ignore
(r/reg-event-db :pretty-elements.slider/increase-value! increase-value!)
