...
(defn clear-button-attributes
  ...
  (-> (if-let [any-option-selected? @(r/subscribe [:pretty-elements.radio-button/any-option-selected? button-id button-props])]
              {:class             :pe-radio-button--clear-button
               :data-click-effect :opacity
               :on-click          #(r/dispatch [:pretty-elements.radio-button/clear-value! button-id button-props])
