...
(defn box-props-prototype
  ...
  (<-walk {:field-value-f  return
          ...
          (fn [%] (merge % box-props))
          (fn [%] (merge % {:on-blur    [:pretty-elements.multi-combo-box/field-blurred box-id %]
                            :on-changed [:pretty-elements.multi-combo-box/field-changed box-id %]
                            :on-focus   [:pretty-elements.multi-combo-box/field-focused box-id %]}))))
