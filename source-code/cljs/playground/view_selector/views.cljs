...
(defn- text
  ...
  [:<> [section-footer]
       ...
       [elements/text {:content config/LOREM-IPSUM :font-size :xxs :style {:max-width "720px"}}]
       [elements/horizontal-separator {:size :l}]
       [elements/text {:content config/LOREM-IPSUM :font-size :xs  :style {:max-width "720px"}}]
       [elements/horizontal-separator {:size :l}]
       [elements/text {:content config/LOREM-IPSUM :font-size :s   :style {:max-width "720px"}}]
       [elements/horizontal-separator {:size :l}]
       [elements/text {:content config/LOREM-IPSUM :font-size :m   :style {:max-width "720px"}}]
       [elements/horizontal-separator {:size :l}]
       [elements/text {:content config/LOREM-IPSUM :font-size :l   :style {:max-width "720px"}}]
       [elements/horizontal-separator {:size :l}]
       [elements/text {:content config/LOREM-IPSUM :font-size :xl  :style {:max-width "720px"}}]
       [elements/horizontal-separator {:size :l}]
       [elements/text {:content config/LOREM-IPSUM :font-size :xxl :style {:max-width "720px"}}]
       [section-footer]])
